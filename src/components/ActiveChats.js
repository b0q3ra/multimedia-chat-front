...
const ActiveChats = () => {
  const usersURL = `${process.env.REACT_APP_API_URL}/user/users`//users url
  ...
  return (
    <div className="border-r border-gray-300 lg:col-span-1">
      ...
      {displayChats && <ListChats listOfChats={[{ email: 'sergibofu@gmail.com' }, { email: 'jpujol@gmail.com' }]} />}
      {!displayChats && <ListUsers listOfUsers={[{ email: 'sergibofu@fkml.com' }, { email: 'jpujol@fkml.com' }]} />}
